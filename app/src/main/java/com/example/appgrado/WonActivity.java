...
public class WonActivity extends AppCompatActivity {
        ...
        btn_Share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    String shareMessage= "\nMi puntuación fue: "+ correcta + " respuestas correctas de 11, en el nivel 1 de Razonamiento Lógico. ";
    ...
    public void irSubmenuRazonamiento(View view){
        Intent i = new Intent(WonActivity.this, SubmenuRazonamiento.class);
        startActivity(i);
